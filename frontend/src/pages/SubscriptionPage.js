  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-zinc-400 mt-1">Plano do dono da academia: R$ 139,90/mês.</p>
      </div>
      ...
      <div className={`rounded-md border p-5 ${active ? 'border-green-500/20 bg-green-500/5' : 'border-yellow-500/20 bg-yellow-500/5'}`}>
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-zinc-400">Grace até: {formatDate(status?.grace_until)}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-md p-5 space-y-4">
        ...
        <p className="text-sm text-zinc-400">O acesso ao sistema permanece bloqueado enquanto a assinatura estiver inativa.</p>
