...
async def init_indexes() -> None:
    ...
    await db.owners.create_index("owner_id", unique=True)
    ...
    await db.students.create_index([("owner_id", 1), ("status", 1)])
    await db.students.create_index([("owner_id", 1), ("created_at", -1)])
    await db.students.create_index([("owner_id", 1), ("email", 1)])
